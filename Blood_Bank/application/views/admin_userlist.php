...
<div style="height:500px;">
	...
	<div style="background-image:url('<?php echo base_url('images/blood6.jpg');?>');background-size:cover;height:150%;">
		...
		<h1 align="center" style="font-family:Georgia, 'Times New Roman', Times, serif;font-size:40px;color:#FFFFFF"><b>User List</b></h1>	
		...
		<tr >
		<th>Name</th><th>Address</th><th>Gender</th><th>Email</th><th>Phone</th><th>Action</th>
		</tr>	
		<?php 
		foreach($type as $row)
		{
		...
		<td><?php echo $name;?></td><td width="15%"><?php echo $address;?></td><td><?php echo $gender;?></td><td><?php echo $email;?></td><td><?php echo $phone;?></td><td><input type="submit" value="<?php echo $status ?>" id="block" name="block" style="background-color:#00FF00">
